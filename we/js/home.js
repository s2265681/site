...
//渐隐轮播图Jquery
 var data = ['../img1/002.jpg','../img1/003.jpg','../img1/001.jpg','../img1/005.jpg','../img1/006.jpg','../img1/007.jpg',
 '../img1/053.jpg','../img1/103.jpg'];
    ...
    for(var i = 0; i < data.length; i++){
        ctrl_str += '<li>'+(i+1)+'</li>';
        pic_str += '<li><img width="800" height="400" src=" ' + data[i] + ' "></li>';
    }
    $('.box').html(pic_str);
    ...
    // 	if(document.getElementsByTagName('body')[0].scrollTop<50){
    // 		document.getElementById("top").className="sun";
    // 	}else{
